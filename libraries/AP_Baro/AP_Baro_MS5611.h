...
public:
	...
	virtual int16_t read_16bits_2(uint8_t reg) = 0;
    /** Read a 24-bit value */
    virtual uint32_t read_24bits(uint8_t reg) = 0;
	virtual uint32_t read_24bits_2(uint8_t reg) = 0;
...
public:
    ...
    uint32_t read_24bits_2(uint8_t reg){return 0;}
    int16_t read_16bits_2(uint8_t reg){return 0;}
...
public:
    ...
    void init();
    uint16_t read_16bits(uint8_t reg);
    int16_t read_16bits_2(uint8_t reg);
    uint32_t read_24bits(uint8_t reg);
    uint32_t read_24bits_2(uint8_t reg);
    void write(uint8_t reg);
    void writeReg(uint8_t reg, uint8_t value);
