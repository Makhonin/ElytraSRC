...
void AP_MotorsQuad::setup_motors()
{
    ...
    if( _flags.frame_orientation == AP_MOTORS_PLUS_FRAME ) {
        ...
        */
		...
		// X frame set-up
        add_motor2(AP_MOTORS_MOT_1,   45, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 1);
        add_motor2(AP_MOTORS_MOT_2, -135, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 3);
        add_motor2(AP_MOTORS_MOT_3,  -45, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  4);
        add_motor2(AP_MOTORS_MOT_4,  135, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  2);
    }
}
