...
void LIS3MDL_TWI::begin()
{
    ...
    if (hal.i2c->writeRegister(_addr, 0x22,0)!=0)
	{
...
void LIS3MDL_TWI::writeCtrlReg2()
{
    ...
    Wire.endTransmission();*/
    if (hal.i2c->writeRegister(_addr, CTRL_REG2,_ctrlReg2)!=0)
	{
		hal.console->println("I2C error.");
	}
}
...
void LIS3MDL_TWI::writeCtrlReg3()
{
    ...
    Wire.endTransmission();*/
    if (hal.i2c->writeRegister(_addr, CTRL_REG3,_ctrlReg3)!=0)
	{
		hal.console->println("I2C error.");
	}
}
...
void LIS3MDL_TWI::writeCtrlReg5()
{
    ...
    Wire.endTransmission();*/
    if (hal.i2c->writeRegister(_addr, CTRL_REG5,_ctrlReg5)!=0)
	{
		hal.console->println("I2C error.");
	}
}
